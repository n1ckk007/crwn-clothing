...
export declare const Base: ({ eyes: Eyes, eyebrows: Eyebrows, mouth: Mouth, hair, facialHair: FacialHair, clothing, accessory: Accessory, graphic: Graphic, hat, body, hairColor, clothingColor, circleColor, lipColor, hatColor, mask, lashes, ...rest }: BaseProps) => JSX.Element;
export {};
